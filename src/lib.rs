//! ONDEWO SIP (SIP Telephony) gRPC client.
//!
//! Everything under [`api`] is GENERATED from the protos of the `ondewo-sip-api` submodule by the
...
//! `package ondewo.sip;` is reachable as `ondewo::sip::<Message>` and each gRPC service
//! as `ondewo::sip::<service>_client::<Service>Client`.
//!
